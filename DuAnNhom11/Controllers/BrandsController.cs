...
namespace DuAnNhom11.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(DuAnNhom11Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Brand != null ? 
                          ...
                          Problem("Entity set 'DuAnNhom11Context.Brand'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DuAnNhom11Context.Brand'  is null.");
            }
            var brand = await _context.Brand.FindAsync(id);
            if (brand != null)
            {
